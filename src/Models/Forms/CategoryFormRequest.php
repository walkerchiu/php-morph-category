    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            if (isset($data['host_type']) && isset($data['host_id'])) {
                if ( config('wk-morph-category.onoff.site') && !empty(config('wk-core.class.site.site')) && $data['host_type'] == config('wk-core.class.site.site') ) {
                ...
                } elseif ( config('wk-morph-category.onoff.group') && !empty(config('wk-core.class.group.group')) && $data['host_type'] == config('wk-core.class.group.group') ) {
            ...
            if (isset($data['identifier']) && !in_array($data['identifier'], ['#', '/'])) {
